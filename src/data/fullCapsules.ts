    ...
    sections: [
      {
        ...
        content: "Comprar un vehículo es una de las inversiones más importantes que harás en tu vida. La forma en que lo financias puede ahorrarte miles de dólares o costarte muchísimo más de lo necesario. En esta cápsula aprenderás las cuatro principales formas de adquirir un vehículo: compra de contado, crédito tradicional, leasing operativo y renting. Cada una tiene ventajas y desventajas según tu situación financiera, uso previsto del vehículo y objetivos personales. Al final, sabrás exactamente cuál método se ajusta a tu perfil y cómo negociar las mejores condiciones.",
      },
      {
        id: "concept_14",
        order: 2,
    ...
    sections: [
      ...
      },
      {
        ...
        bulletPoints: [
          ...
          "El Ferrari Testarossa de los años 80 costaba más de $300,000 en su época",
  ...
  // Capsule 17: Mantenimiento Planificado
  {
    ...
    sections: [
      ...
      },
      {
        ...
        content: "Los números que cambian tu perspectiva: OIL CHANGE: $80-120 vs ENGINE REPLACEMENT: $3,000-8,000. BRAKE PADS: $150-300 vs ROTOR REPLACEMENT: $400-800. TIRE ROTATION: $25-50 vs TIMING BELT: $800-1,500. AIR FILTER: $15-30 vs AC COMPRESSOR: $1,200-2,500. ENGINE FLUSH: $50-80 vs ENGINE REBUILD: $4,000-8,000. La matemática es simple: $100 en mantenimiento prevents $1,000 en repairs. Un auto con mantenimiento programado typical costs 50-70% less en total lifecycle compared to neglect.",
      },
      {
        id: "tips_mant_1",
        order: 4,
  ...
  // Capsule 18: Vehículos eléctricos
  {
    ...
    sections: [
      ...
      },
      {
        ...
        content: "Los EVs desafían preconceptions sobre performance y eficiencia: ACCELERATION: Instant torque delivery means 0-60 mph en 3-5 seconds, comparable to sports cars. POWER DELIVERY: Linear acceleration, no shifting required, instant response. EFFICIENCY: 85-95% energy conversion vs 25-35% internal combustion. ENERGY RECOVERY: Regenerative braking recovers 15-25% energy during city driving. RANGE REALITY: 70-80% de advertised range en real-world conditions. CLIMATE IMPACT: 40-60% lower lifecycle emissions vs gasoline vehicles, 90% lower when powered by renewable energy.",
      },
      {
        id: "tips_ele_1",
        order: 4,
        ...
        bulletPoints: [
          "LEVEL 1 (Home): 120V, 4-8 miles range per hour, overnight charging",
          "LEVEL 2 (Home/Public): 240V, 20-40 miles per hour, typical public charging",
          "DC FAST: 50-350kW, 80% charge en 20-40 minutes, highway corridors",
          "COST PER MILE: $0.03-0.08 vs $0.10-0.15 gasoline (Colombia rates)",
          "CHARGING NETWORK: Tesla Supercharger, IONITY, ChargePoint, local networks",
          "GRID IMPACT: Smart charging management, vehicle-to-grid potential"
        ],
      },
      {
        id: "concept_ele_3",
