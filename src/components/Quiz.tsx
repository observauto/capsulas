...
export const Quiz: React.FC<QuizProps> = ({ questions, onComplete, context = 'standalone', isCompleted = false }) => {
                    ...
                    <div className="space-y-3">
                      {question.options.map((option, optionIndex) => {
                        ...
                        return (
                          <div
                            key={optionIndex}
                            className={`flex items-center space-x-3 p-4 rounded-xl border-2 transition-all cursor-pointer ${isSelected
